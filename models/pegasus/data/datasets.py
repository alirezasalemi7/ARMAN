...
def getDatasetListsForCurrentSteps():
  return {
    "all_datasets_rouge" : ["ir_blogs_rouge-train","miras_rouge-train","asr_iran_rouge-train","persian_cc_rouge-train","yjc_rouge-train"],
    "all_datasets_semantic" : ["ir_blogs_semantic-train","miras_semantic-train","asr_iran_semantic-train","persian_cc_semantic-train","yjc_semantic-train"],
    "all_datasets_semantic_mask_only" : ["ir_blogs_semantic_v2-train","miras_semantic_v2-train","asr_iran_semantic_v2-train","persian_cc_semantic_v2-train","yjc_semantic_v2-train"],
    "all_datasets_semantic_shuffle" : ["ir_blogs_semantic_v3-train","miras_semantic_v3-train","asr_iran_semantic_v3-train","persian_cc_semantic_v3-train","yjc_semantic_v3-train"]    
  }
...
class TFDSDataset(BaseDataset):
  ...
  def build(self, input_pattern, shuffle_files):
    ...
    """
    "".startswith
    if input_pattern.startswith("all_datasets"):
      my_train_Dataset_patterns = getDatasetListsForCurrentSteps()[input_pattern.split("-")[0]]
    else:
