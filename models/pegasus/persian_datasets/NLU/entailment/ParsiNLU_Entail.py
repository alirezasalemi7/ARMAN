...
class ParsiNLU_Entailment(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            tfds.core.SplitGenerator(
                ...
                gen_kwargs={
                    "raw_texts": os.path.join(extracted_path, "train/input.txt"),
                    "target_texts": os.path.join(extracted_path, "train/target.txt")
                },
            ),
            tfds.core.SplitGenerator(
                name=tfds.Split.TEST,
                gen_kwargs={
                    "raw_texts": os.path.join(extracted_path, "test/input.txt"),
                    "target_texts": os.path.join(extracted_path, "test/target.txt")
                },
            ),
            tfds.core.SplitGenerator(
