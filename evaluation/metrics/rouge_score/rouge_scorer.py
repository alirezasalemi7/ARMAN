...
class RougeScorer(scoring.BaseScorer):
    ...
    def __init__(self, rouge_types, use_stemmer=False, lang='en',device="cuda:0"):
        ...
        self.bert_scorer = bs.scorer.BERTScorer(lang="fa",num_layers=9,device=device)
    ...
    def score(self, target, prediction):
        ...
        for rouge_type in self.rouge_types:
            ...
            elif rouge_type == "BERTScore":
                p,r,f = self.bert_scorer.score([prediction],[target])
                scores = scoring.Score(precision=p, recall=r, fmeasure=f)
            else:
